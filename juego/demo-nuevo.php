...
})(window,document,'script','dataLayer','GTM-MQDR7LWF');</script>
...
#hudP{
  top: 10px;
    ...
    @media screen and (max-width: 949px) {
      ...
      #combustible, #combustible_valor, #puntos, #puntos_valor {
        font-size: 18px;
        transition: all ;
      }
  ...
  <div class="maquina">
    ...
    <div id="item2" class="item2" style=" z-index: 2;">
      ...
      <img src="images/instruh.png" alt="" class="img-pre2"> </div>
  ...
  <div style="display: none;">
    ...
    <div id="id_jugador" hidden class="value"> </div>
    <div id="tipo" hidden class="value"></div>
    <div id="nivel" hidden class="value"></div>
    <p id="documento"></p>
    <p id="imei"></p>
  </div>
  ...
  <script src="demo-nuevo.js"></script>
