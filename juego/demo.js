...
var id = "0000";//document.getElementById("id_jugador").innerText;
...
if (windowWidth < windowHeight) {
    ...
    $myCanvas.style.width = 250 + "%";//windowWidth+ "px";
    $myCanvas.style.height = 100 + "%";//45 + "em";
    // $myCanvas.style.marginLeft = -65 + "%";
    // $myCanvas.style.marginTop = 43 + "%";    
    // $myCanvas.style.width = 1000 + "px";//windowWidth+ "px";
    // $myCanvas.style.height = 700 + "px";//45 + "em";
    // $myCanvas.style.marginLeft = -77 + "%";
    // $myCanvas.style.marginTop = 43 + "%";
...
function finEnviarBD() {
    if (!transmitir) {
       ...
       // window.location.href = "../puntuacion.php?res=" + string1 + "&preguntas=" + preguntas_correctas + "&puntaje=" + scoreFinal + "&vuelta=" + currentLapTime + "&id=" + id + "&ptotal=" + string1;
...
async function update(dt) {
    ...
    updateHud('puntos', Util.toInt(puntaje * multiplica));
...
function render() {
    ...
    switch (vidas) {
        case 1: ctx.drawImage(img4, 310, 120); break;
        case 2: ctx.drawImage(img4, 260, 120); ctx.drawImage(img4, 310, 120); break;
        case 3: ctx.drawImage(img4, 210, 120); ctx.drawImage(img4, 310, 120); ctx.drawImage(img4, 260, 120); break;
        case 4: ctx.drawImage(img4, 160, 120); ctx.drawImage(img4, 210, 120); ctx.drawImage(img4, 310, 120); ctx.drawImage(img4, 260, 120); break;
        case 5: ctx.drawImage(img4, 110, 120); ctx.drawImage(img4, 210, 120); ctx.drawImage(img4, 310, 120); ctx.drawImage(img4, 260, 120); ctx.drawImage(img4, 160, 120); break;
    }
